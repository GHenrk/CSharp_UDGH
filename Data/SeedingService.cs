...

{
    ...
    {
        private CSharpUdemy_MVCContext _context;

        public SeedingService(CSharpUdemy_MVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            {
                //Se existir algo no banco de dados, não fazer nada, return apenas!
                return;
            }

            Department d1 = new Department(1, "Marley's Shop");
            Department d2 = new Department(2, "Electronics");
            Department d3 = new Department(3, "Fashion");
            Department d4 = new Department(4, "Books");
            Department d5 = new Department(5, "Softwares");


            Seller s1 = new Seller(1, "Bob marley", "cannabis123@gmail.com", new DateTime(1998, 4, 21), 10000.0, d1);
            Seller s2 = new Seller(2, "Gustavo Henrique", "gustavo.henrqd@gmail.com", new DateTime(1998, 5, 25), 10000.0, d5);
            Seller s3 = new Seller(3, "Seller teste 1", "sellerteste1@gmail.com", new DateTime(1998, 1, 25), 1800.0, d2);
            Seller s4 = new Seller(4, "Seller teste 2", "sellerteste2@gmail.com", new DateTime(1990, 8, 28), 100.0, d3);
            Seller s5 = new Seller(5, "Seller teste 3", "sellerteste4@gmail.com", new DateTime(1940, 2, 25), 9000.0, d4);
            Seller s6 = new Seller(6, "Bob marley", "@gmail.com", new DateTime(1995, 6, 10), 8500.0, d4);
